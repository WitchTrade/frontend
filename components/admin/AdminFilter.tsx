...
const AdminFilter: FunctionComponent<Props> = ({
  adminFilterValues,
      ...
      <div className='bg-wt-surface-dark rounded-lg'>
        ...
        <div className='flex flex-col items-center p-2'>
          <TextInput
            ...
            required={false}
            type='text'
            value={adminFilterValues.searchString}
            setValue={(searchString) =>
              setAdminFilterValues({ ...adminFilterValues, searchString })
            }
            clearOption={true}
          />
          <div className='flex flex-wrap justify-center'>
            <div className='m-1' style={{ width: '220px' }}>
              ...
              <Dropdown
                selectedValue={adminFilterValues.verified}
                setValue={(verified) =>
                  setAdminFilterValues({ ...adminFilterValues, verified })
                }
            ...
            <div className='m-1' style={{ width: '220px' }}>
              ...
              <Dropdown
                selectedValue={adminFilterValues.badge}
                setValue={(badge) =>
                  setAdminFilterValues({ ...adminFilterValues, badge })
                }
                values={badgeValues}
              />
            </div>
          ...
          <div className='flex flex-wrap justify-center'>
            <div className='m-1' style={{ width: '220px' }}>
              ...
              <Dropdown
                selectedValue={adminFilterValues.orderBy}
                setValue={(orderBy) =>
                  setAdminFilterValues({ ...adminFilterValues, orderBy })
                }
                values={adminOrderByValues}
              />
            </div>
            <div className='m-1' style={{ width: '220px' }}>
              <p className='mb-1'>Show in</p>
              <Dropdown
                selectedValue={adminFilterValues.orderDirection}
                setValue={(orderDirection) =>
                  setAdminFilterValues({ ...adminFilterValues, orderDirection })
                }
