...
const TextInput: FunctionComponent<Props> = ({ type, placeholder, value, setValue, required, svgPath, handleKeyPress, autocompleteValue, clearOption, onKeyDown }) => {
  ...
  return (
    <div className="relative" >
      <input
        className={`w-full h-11 ${svgPath ? 'pl-9' : 'pl-3'} ${clearOption ? 'pr-8' : 'pr-3'} text-base placeholder-wt-text border border-wt-accent-light rounded-lg bg-wt-surface-dark focus:outline-none focus:ring-2 focus:ring-wt-accent`}
        type={type}
