...
const useSyncSettingsHandler = () => {
  ...
  useEffect(() => {
    if (
      ...
      getRarityNumber(localSyncSettings.rarity.map((r) => r.key)) !==
        syncSettings.rarity ||
      (!localSyncSettings.mainPriceItem && syncSettings.mainPriceItem) ||
      (localSyncSettings.mainPriceItem && !syncSettings.mainPriceItem) ||
      (localSyncSettings.mainPriceItem &&
        syncSettings.mainPriceAmountItem &&
        localSyncSettings.mainPriceItem.id !== syncSettings.mainPriceItem.id) ||
      localSyncSettings.mainPriceAmountItem !==
        syncSettings.mainPriceAmountItem ||
      ...
      (localSyncSettings.secondaryPriceItem &&
        ...
        localSyncSettings.secondaryPriceItem.id !==
          syncSettings.secondaryPriceItem.id) ||
      localSyncSettings.secondaryPriceAmountItem !==
        syncSettings.secondaryPriceAmountItem ||
      (!localSyncSettings.mainPriceRecipe && syncSettings.mainPriceRecipe) ||
      (localSyncSettings.mainPriceRecipe && !syncSettings.mainPriceRecipe) ||
      (localSyncSettings.mainPriceRecipe &&
        syncSettings.mainPriceRecipe &&
        localSyncSettings.mainPriceRecipe.id !==
          syncSettings.mainPriceRecipe.id) ||
      localSyncSettings.wantsBothRecipe.key !== syncSettings.wantsBothRecipe ||
      localSyncSettings.mainPriceAmountRecipe !==
      ...
      (localSyncSettings.secondaryPriceRecipe &&
        ...
        localSyncSettings.secondaryPriceRecipe.id !==
          syncSettings.secondaryPriceRecipe.id) ||
      localSyncSettings.secondaryPriceAmountRecipe !==
