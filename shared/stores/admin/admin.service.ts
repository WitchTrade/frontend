...
export class AdminService {
  public fetchUsers() {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/users`, {
        headers: {
  ...
  public ban(data: { userId: string; reason: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/ban`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public fetchBadges() {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/badges`)
      .pipe(
        tap({
          next: async (res) => {
            if (!res.ok) {
  ...
  public addBadge(data: { userId: string; badgeId: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/badge`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public fetchRoles() {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/roles`)
      .pipe(
        tap({
          next: async (res) => {
            if (!res.ok) {
  ...
  public addRole(data: { userId: string; roleId: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/role`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public verify(data: { userId: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/verify`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public fetchLog() {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/log`)
      .pipe(
        tap({
          next: async (res) => {
            if (!res.ok) {
  ...
  public sendMessage(data: {
    ...
    return authService
      .request(
        `${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/notification`,
        {
          method: 'POST',
          headers: {
            'content-type': 'application/json',
  ...
  public broadcast(data: { text: string; iconLink: string; link: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/admin/broadcast`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
