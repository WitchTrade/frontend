...
export class MarketsService {
  public fetchAllMarkets() {
    return fromFetch(
      `${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets`
    ).pipe(
      tap({
        next: async (res) => {
          if (!res.ok) {
  ...
  public fetchOwnMarket() {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/own`)
      .pipe(
        tap({
          next: async (res) => {
            if (!res.ok) {
  ...
  public editMarket(body: { offerlistNote: string; wishlistNote: string }) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets`, {
        method: 'PUT',
        headers: {
  ...
  public fetchUserMarket(username: string) {
    return fromFetch(
      `${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/user/${username}`
    ).pipe(
      tap({
        next: async (res) => {
  ...
  public createOffer(offer: any) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/offers`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public updateOffer(id: number, offer: any) {
    return authService
      .request(
        `${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/offers/${id}`,
        {
          method: 'PUT',
          headers: {
            'content-type': 'application/json',
  ...
  public createWish(wish: any) {
    return authService
      .request(`${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/wishes`, {
        method: 'POST',
        headers: {
          'content-type': 'application/json',
        },
  ...
  public updateWish(id: number, wish: any) {
    return authService
      .request(
        `${process.env.NEXT_PUBLIC_BASE_API_URL}/api/markets/wishes/${id}`,
        {
          method: 'PUT',
          headers: {
            'content-type': 'application/json',
