      ...
      {market.id &&
        <>
          ...
          <div className="flex flex-col justify-center max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-between mb-2 items-end">
              ...
              {editingNote &&
                <div className="flex">
                  <div className="mx-1">
                    <ActionButton type="success" disabled={localNote.length > 250 || (localNote.match(/\n/g) || []).length + 1 > 10} onClick={() => updateNote()}>Save</ActionButton>
                  </div>
                  <div className="mx-1">
            ...
            {editingNote &&
              <>
                ...
                <p className={`text-sm ${localNote.length > 250 ? 'text-wt-error' : ''}`}>{localNote.length}/250 characters</p>
          ...
          <div className="flex flex-wrap justify-center mt-10">
            ...
            {(type === MARKET_TYPE.OFFER && market.offers.length > 3 && !newOfferView || type === MARKET_TYPE.WISH && market.wishes.length > 3) &&
              <div className="m-1">
