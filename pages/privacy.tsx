    ...
    <>
      ...
      <div className='px-4 mx-auto max-w-6xl sm:px-6 lg:px-8'>
        ...
        <Section>
          ...
          ,&quot; or &quot;<b>our</b>&quot;). We are committed to protecting
        ...
        <ul className='pl-8 list-disc'>
          ...
          <li>
            &quot;<b>Services</b>,&quot; we are referring to our Website, and
        ...
        <Link href='#8'>
          <a className='text-wt-accent hover:underline cursor-pointer'>
            <p>8. Do California residends have specific privacy rights?</p>
          </a>
        </Link>
        <Link href='#9'>
          <a className='text-wt-accent hover:underline cursor-pointer'>
        ...
        <ul className='pl-8 list-disc'>
          ...
          <li>
            ...
            please contact us at witchtrade.org @gmail.com and be sure to
        ...
        <Section>
          ...
          from outside Germany, please be aware that your information may be
        ...
        <Section>
          ...
          Website is at your own risk.You should only access the Website within
        ...
        <Section>
          ...
          email us at witchtrade.org @gmail.com.
        </Section>
        Account Information
        ...
        <Section>
          ...
          to review, update, or delete your personal information, please email
          us at witchtrade.org@gmail.com. This privacy policy was created using{' '}
