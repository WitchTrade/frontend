...
const Broadcast: NextPage = () => {
  const { broadcastNotification, setBroadcastNotification, broadcast } =
    AdminHandler()
    ...
    <LoginWrapper admin={true}>
      ...
      <div className='flex flex-col justify-center py-2 px-4 mx-auto max-w-3xl sm:px-6 lg:px-8'>
        <div className='m-1'>
          <TextInput
            type='input'
            value={broadcastNotification.text}
            setValue={(text) =>
              setBroadcastNotification({ ...broadcastNotification, text })
            }
            placeholder='Text'
            required={true}
          />
        ...
        <div className='m-1'>
          <TextInput
            type='input'
            value={broadcastNotification.link}
            setValue={(link) =>
              setBroadcastNotification({ ...broadcastNotification, link })
            }
            placeholder='Link'
            required={false}
          />
        ...
        <div className='m-1'>
          <TextInput
            type='input'
            value={broadcastNotification.iconLink}
            setValue={(iconLink) =>
              setBroadcastNotification({ ...broadcastNotification, iconLink })
            }
        ...
        <div className='flex justify-center my-1'>
          <ActionButton
            type='success'
            disabled={!broadcastNotification.text}
            onClick={() => broadcast()}
          >
            Send
          </ActionButton>
