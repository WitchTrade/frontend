...
const Home: NextPage = () => {
  return (
    <div className="mx-auto px-4 sm:px-32 lg:px-48" style={{ maxWidth: '1500px' }}>
      ...
      <p className="sm:text-xl text-center">WitchTrade is a trading website dedicated to <Link href="https://store.steampowered.com/app/559650/Witch_It/"><a className="hover:underline text-wt-accent cursor-pointer" target="_blank" rel="noreferrer">Witch It</a></Link>, a hide and seek game. It can be used to find and offer cosmetic items.</p>
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/itemList.png" width={772} height={609} quality={100} alt="Item list" />
        </div>
      ...
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        ...
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/search.png" width={760} height={520} quality={100} alt="Search" />
        </div>
      </div>
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/profile.png" width={620} height={400} quality={100} alt="Profile" />
        </div>
        <div className="w-full sm:w-1/2 flex justify-center items-center">
      ...
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        ...
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/filter.png" width={941} height={484} quality={100} alt="Filter" />
        </div>
      </div>
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/inventory.png" width={471} height={189} quality={100} alt="Inventory" />
        </div>
        <div className="w-full sm:w-1/2 flex justify-center items-center">
      ...
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        ...
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/gameServers.png" width={335} height={356} quality={100} alt="Game servers" />
        </div>
      </div>
      <div className="flex flex-wrap my-4 rounded-lg border-4 border-wt-accent p-1 bg-wt-surface-dark">
        <div className="w-full sm:w-1/2 p-2 flex justify-center">
          <Image className="rounded-xl" src="/assets/images/home/gameServerStats.png" width={401} height={408} quality={100} alt="Game server stats" />
        </div>
        <div className="w-full sm:w-1/2 flex justify-center items-center">
