...
const Legal: NextPage = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Section>
        Email: witchtrade.org@gmail.com
      </Section>
      ...
      <Section>
        The site may contain third-party text materials that have been uploaded by users of the site. We assume no liability for this.
      </Section>
      ...
      <Section>
        All data (images, text and other information) provided by the game Witch It belong to Barrel Roll Games (<Link href="https://barrelrollgames.com/"><a className="hover:underline text-wt-accent cursor-pointer" target="_blank" rel="noreferrer">https://barrelrollgames.com/</a></Link>).
      </Section>
    </div >
  );
};
